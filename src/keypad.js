function Keypad({handleClick,handleClear,calculate,handleBack}) {
  return (
    <div className="keypad">
      <div className="row">
        <button onClick={()=>handleClick("**")} className="func-key">^</button>
        <button onClick={()=>handleClick("%")} className="func-key">%</button>
        <button onClick={()=>handleBack()} className="func-key">DEL</button>
        <button onClick={()=>handleClear()} className="func-key">CLR</button>  
      </div>  
      <div className="row">
